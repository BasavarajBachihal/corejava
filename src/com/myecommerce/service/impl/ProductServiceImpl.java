...
/***
 * @author myecommerce pvt ltd class name: ProductServiceImpl description:
 *  This class helps to provide functionality like adding new product to the
 *         system, searching product, getting product details, updating, deleting product
 */
public class ProductServiceImpl implements ProductService {
	...
	public ProductDTO deleteProductByIdNonDB(Long productId) {
		...
		/*
		 * Iterator<ProductDTO> productDtoItr = productList.iterator(); ProductDTO dto = null;
		 * while(productDtoItr.hasNext()) { 
		 * if(dto.getProductId().equals(productId)) {dto = productDtoItr.next(); productDtoItr.remove(); } } return dto;
		 */
